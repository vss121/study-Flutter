...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: SafeArea(  // SafeArea는 안전한 영역 
        child: Scaffold(
          key: _scaffoldKey,
          appBar: AppBar(
            title: Text('My Quiz APP'),
            backgroundColor: Colors.deepPurple,
            leading: Container(), // 페이지 이동 시 자동으로 생기는 뒤로가기 버튼 등 지우는 효과도 있음 
          ),
          body: Column(
            ...
            children: <Widget>[
              Center(
                child: Image.asset(
                  'images/quiz.jpeg', // pubspec.yaml에서 quiz.jpeg 등록 추가 
                  width: width * 0.8,
                ),
              ),
              Padding(
              ...
              _buildStep(width, '1. 랜덤으로 나오는 퀴즈 3개를 풀어보세요.'), // _buildStep 이라는 함수로 
